    ...
    descriptions: [
      {
        ...
        details: 'Developed a full-stack website using Next.js to integrate front-end and back-end functionalities, providing a seamless and dynamic user experience for school-related information.',
        technologies: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS']
      },
      {
        project: 'Curly Cuts Pet Grooming',
        details: 'Designed a responsive front-end for Curly Cuts using Next.js, focusing on a modern and user-friendly web page design.',
